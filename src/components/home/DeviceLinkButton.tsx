        ...
        {[{ title: "Website", icon: <Globe className="w-8 h-8" />, url: "/comingSoon" },
          ...
          >
            <Link href={item.url} legacyBehavior>
              <a className="inline-flex items-center px-6 py-3 bg-gray-800 text-lg font-medium text-white rounded-full hover:bg-gray-700 transition-colors duration-300 flex-col sm:flex-row">
                {item.icon}
