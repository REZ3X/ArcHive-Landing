...
const PlannedFeature = () => {
  const features = [
    { title: "Community", description: "Connect with other writers and thinkers.", icon: <Users className="w-6 h-6" /> },
    ...
    { title: "Typing Training", description: "Improve your typing speed and accuracy.", icon: <Keyboard className="w-6 h-6" /> }
  ];
