  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-gray-800 py-8 px-4 sm:px-6 lg:px-8 max-425:max-w-[425px]">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-3xl font-bold text-white mb-2 max-425:text-2xl">Patch Notes</h1>
        ...
        <div className="space-y-6">
          {patchNotes.map((patch) => (
            ...
            >
              ...
              >
                <div>
                  <div className="flex items-center">
                    <h2 className="text-xl font-semibold text-white">v{patch.version}</h2>
              ...
              <div className={`px-6 ${expandedVersion === patch.version ? 'py-4 border-t border-gray-700' : 'hidden'}`}>
                <div className="mb-4">
                  <h3 className="text-sm font-medium text-yellow-400 uppercase tracking-wider mb-2">Highlights</h3>
                ...
                <div>
                  <h3 className="text-sm font-medium text-yellow-400 uppercase tracking-wider mb-2">Details</h3>
                  <ul className="list-disc pl-5 text-gray-300">
