...
const Infrastructure = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-900 text-white font-nunito">
      <h1 className="text-4xl md:text-6xl font-bold mb-8 text-yellow-400">Infrastructure</h1>
          ...
          <div key={index} className="bg-gray-800 p-6 rounded-lg shadow-lg text-center w-72 h-72 flex flex-col justify-center">
            ...
            <ul className="text-gray-300">
              {section.technologies.map((tech, idx) => (
                <li key={idx} className="mb-2 flex items-center justify-center space-x-2">
                  {tech.icon}
                  <span>{tech.name}</span>
                </li>
              ))}
